...
func main() {
	...
	p2pBootstrap := "/dns4/wormhole-mainnet-v2-bootstrap.certus.one/udp/8996/quic/p2p/12D3KooWQp644DK27fd3d4Km3jr7gHiuJJ5ZGmy8hH4py7fP4FP7,/dns4/wormhole-v2-mainnet-bootstrap.xlabs.xyz/udp/8996/quic/p2p/12D3KooWNQ9tVrcb64tw6bNs2CaNrUGPM7yRrKvBBheQ5yCyPHKC"
	nodeKeyPath := "./mainnet_test.nodeKey"

	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	logger, _ := zap.NewDevelopment()

	signingKeyPath := string("./mainnet_test.signerKey")

	logger.Info("Loading signing key", zap.String("signingKeyPath", signingKeyPath))
	sk, err := common.LoadArmoredKey(signingKeyPath, CCQ_SERVER_SIGNING_KEY, true)
	if err != nil {
	...
	url := "https://rpc.ankr.com/eth/de829957773bb0fa9e0aaeab57d988707e60eb06ae36be0658b778072d94979d"
